    ...
    <nav class="topbar">
        <div class="topbar-inner">
            ...
            <div class="topbar-nav">
                ...
                <a href="<?= htmlspecialchars(BASE_URL, ENT_QUOTES, 'UTF-8') ?>/index.php" class="topbar-nav-icon"
                    title="Accueil">
                    <i class="ri-home-5-fill"></i>
                </a>

                <a href="<?= htmlspecialchars(BASE_URL, ENT_QUOTES, 'UTF-8') ?>/messages.php" class="topbar-nav-icon"
                    title="Messages">
                ...
                <a href="<?= htmlspecialchars(BASE_URL, ENT_QUOTES, 'UTF-8') ?>/groups.php" class="topbar-nav-icon"
                    title="Groupes">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end profile-dropdown">
                        <li>
                            <a class="dropdown-item"
                                href="<?= htmlspecialchars(BASE_URL . '/profile.php?id=' . $viewerId, ENT_QUOTES, 'UTF-8') ?>">
                                <div class="profile-dropdown-user">
                                    <div class="profile-dropdown-avatar">
                                        <?= htmlspecialchars($viewerInitial, ENT_QUOTES, 'UTF-8') ?>
                                    </div>
                                    <div>
                        ...
                        <li><a class="dropdown-item"
                                href="<?= htmlspecialchars(BASE_URL . '/settings.php', ENT_QUOTES, 'UTF-8') ?>"><i
                                    class="ri-settings-3-fill me-2"></i>Paramètres</a></li>
                        <li><a class="dropdown-item"
                                href="<?= htmlspecialchars(BASE_URL . '/friends.php', ENT_QUOTES, 'UTF-8') ?>"><i
                                    class="ri-user-3-fill me-2"></i>Amis</a></li>
                        <li><a class="dropdown-item"
                                href="<?= htmlspecialchars(BASE_URL . '/messages.php', ENT_QUOTES, 'UTF-8') ?>"><i
                                    class="ri-message-2-fill me-2"></i>Messages</a></li>
                        <li><a class="dropdown-item"
                                href="<?= htmlspecialchars(BASE_URL . '/groups.php', ENT_QUOTES, 'UTF-8') ?>"><i
                                    class="ri-group-fill me-2"></i>Groupes</a></li>
                        <li><a class="dropdown-item text-danger"
                                href="<?= htmlspecialchars(BASE_URL . '/auth/logout.php', ENT_QUOTES, 'UTF-8') ?>"><i
                                    class="ri-logout-box-r-fill me-2"></i>Se déconnecter</a></li>
                    </ul>
                </div>
        ...
        <div class="container profile-hero-container">
            <div class="profile-hero-row">
                ...
                <div class="profile-avatar-wrapper">
                    ...
                    <?php if ($isOwn): ?>
                        <button class="avatar-edit-btn" title="Changer la photo" data-bs-toggle="modal"
                ...
                <div class="profile-hero-info">
                    <h1 class="profile-hero-name"><?= htmlspecialchars($profile['username'], ENT_QUOTES, 'UTF-8') ?>
                    </h1>
                    <p class="profile-hero-sub">
                        ...
                        &nbsp;·&nbsp;
                        <i class="ri-user-3-line"></i> <?= count($realFriends) ?>
                        ami<?= count($realFriends) > 1 ? 's' : '' ?>
                    </p>
                </div>
            ...
            <div class="profile-tabs">
                ...
                <a href="?id=<?= $userId ?>&tab=about" class="profile-tab<?= $tab === 'about' ? ' active' : '' ?>">À
                    propos</a>
                <a href="?id=<?= $userId ?>&tab=friends" class="profile-tab<?= $tab === 'friends' ? ' active' : '' ?>">
                    Amis
                ...
                <div class="pcard">
                    ...
                    <div class="pcard-body">
                        ...
                        <ul class="intro-list mt-3">
                            ...
                            <li><i class="ri-map-pin-fill"></i> <?= htmlspecialchars(SITE_PLACE, ENT_QUOTES, 'UTF-8') ?>
                            </li>
                            <li><i class="ri-user-3-fill"></i> <?= count($realFriends) ?>
                                ami<?= count($realFriends) > 1 ? 's' : '' ?></li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="group-list">
                                <?php foreach (array_slice($groupsData, 0, 3) as $g): ?>
                                    <div class="group-item">
                                        <div class="group-icon" style="background:<?= htmlspecialchars($g['color'], ENT_QUOTES, 'UTF-8') ?>20;
                            ...
                            <div class="friends-grid">
                                <?php foreach (array_slice($realFriends, 0, 9) as $f): ?>
                                    <div class="friend-thumb">
                                        <a
                                            href="<?= htmlspecialchars(BASE_URL . '/profile.php?id=' . $f['id'], ENT_QUOTES, 'UTF-8') ?>">
                        ...
                        <div class="pcard composer-card">
                            <div class="pcard-body">
                                <div class="composer-top-row">
                                    ...
                                    <button class="composer-trigger" data-bs-toggle="modal" data-bs-target="#modalCompose">
                                ...
                                <div class="composer-shortcuts">
                                    <button class="composer-shortcut" data-bs-toggle="modal" data-bs-target="#modalCompose">
                                        ...
                                        <div class="post-head">
                                            ...
                                            <?php if ($isOwn): ?>
                                                <div class="ms-auto dropdown">
                                                    <button class="post-menu-btn dropdown-toggle" data-bs-toggle="dropdown">
                                                        <i class="ri-more-fill"></i>
                                                    </button>
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        <li>
                                                            <button type="button" class="dropdown-item text-danger"
                                                                onclick="openDeleteModal(<?= (int) $post['id'] ?>)">
                ...
                <?php elseif ($tab === 'notifications'): ?>
                    <div class="pcard">
                        <div class="pcard-head d-flex justify-content-between align-items-center">
                            ...
                            <?php if ($unreadNotifCount > 0): ?>
                                <span class="badge bg-danger"><?= $unreadNotifCount ?> non
                                    lue<?= $unreadNotifCount > 1 ? 's' : '' ?></span>
                            <?php endif; ?>
                        </div>
                            ...
                            <?php else: ?>
                                <?php foreach ($notifications as $n):
                                    ...
                                    <div class="notif-item<?= $isUnread ? ' unread' : '' ?>">
                                        <div class="notif-icon" style="background:<?= $nc['color'] ?>20; color:<?= $nc['color'] ?>">
                                            <i class="<?= $nc['icon'] ?>"></i>
                                        </div>
                            ...
                            <ul class="about-list">
                                <li><i class="ri-user-3-fill"></i>
                                    <span><strong>Nom :</strong>
                                        <?= htmlspecialchars($profile['username'], ENT_QUOTES, 'UTF-8') ?></span>
                                </li>
                                ...
                                <li><i class="ri-map-pin-fill"></i>
                                    <span><strong>Lieu :</strong>
                                        <?= htmlspecialchars(SITE_PLACE, ENT_QUOTES, 'UTF-8') ?></span>
                                </li>
                                <li><i class="ri-user-3-fill"></i>
            ...
            <div class="group-list-full">
                <?php foreach ($groupsData as $g): ?>
                    <div class="group-full-item">
                        <div class="group-icon-lg" style="background:<?= htmlspecialchars($g['color'], ENT_QUOTES, 'UTF-8') ?>20;
                                color:<?= htmlspecialchars($g['color'], ENT_QUOTES, 'UTF-8') ?>">
                            <i class="<?= htmlspecialchars($g['icon'], ENT_QUOTES, 'UTF-8') ?>"></i>
                        </div>
                ...
                <div class="modal-content modal-custom">
                    ...
                    <div class="modal-body">
                        <form method="post" action="<?= htmlspecialchars($profilePageUrl, ENT_QUOTES, 'UTF-8') ?>">
                            <textarea name="bio" rows="4" maxlength="500" class="form-control mb-3"
                ...
                <div class="modal-content modal-custom">
                    ...
                    <div class="modal-body">
                        <form method="post"
                            ...
                            <textarea name="body" rows="4" maxlength="10000" placeholder="Que voulez-vous partager ?"
                ...
                <div class="modal-content modal-custom">
                    ...
                    <div class="modal-body">
                        <form method="post"
                            ...
                            <input type="hidden" name="redirect"
                                value="<?= htmlspecialchars($profilePageUrl, ENT_QUOTES, 'UTF-8') ?>">
                            <textarea name="body" id="editPostBody" rows="4" maxlength="10000" class="compose-textarea mb-3"
...
════════════════════════════════════════════════ -->
        <div class="modal fade" id="modalDeletePost" tabindex="-1" aria-labelledby="modalDeletePostLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-sm">
                <div class="modal-content modal-custom" style="border-top: 4px solid #e53935;">
                    <div class="modal-header border-0 pb-0">
                        <div class="d-flex align-items-center gap-2">
                            <div
                                style="width:38px;height:38px;border-radius:50%;background:#fdecea;display:flex;align-items:center;justify-content:center;">
                                <i class="ri-delete-bin-2-fill" style="color:#e53935;font-size:1.2rem;"></i>
                            </div>
                            <h5 class="modal-title mb-0" id="modalDeletePostLabel">Supprimer la publication</h5>
                        </div>
                    ...
                    <div class="modal-footer border-0 pt-2">
                        <form method="post" action="<?= htmlspecialchars($profilePageUrl, ENT_QUOTES, 'UTF-8') ?>"
                            ...
                            <button type="submit" class="btn btn-danger btn-sm ms-2">
                                <i class="ri-delete-bin-fill me-1"></i>Supprimer
                            </button>
                        </form>
                    </div>
                </div>
...
════════════════════════════════════════════════ -->
    ...
    <script>
        ...
        function openDeleteModal(postId) {
            ...
            const modalEl = document.getElementById('modalDeletePost');
